...
@media (max-width: 1100px) {
	...
	body.ts-thirdparty-events .ts-events-filter-form .liste_titre { grid-template-columns: minmax(220px, 1fr) minmax(150px, .7fr) minmax(180px, .8fr) minmax(120px, auto); }
}
@media (max-width: 760px) {
