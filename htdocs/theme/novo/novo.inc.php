...
/**
 *	\file       htdocs/theme/novo/novo.inc.php
 *	\brief      Novo: flat, cool-neutral palette on the shared horizontal shell.
 *
 *	The palette is re-expressed from the Novo theme for Dolibarr
 *	(https://github.com/FlowMatrix-AI/dolibarr-novo-theme, GPL-3.0, FlowMatrix-AI):
 *	its generated tokens/default.json values are restated here in this project's
 *	--c-* contract, so the whole thriveshell component layer applies unchanged
 *	rather than a second theming system being carried alongside it.
 *
...
:root {
	...
	--c-accent-ring: rgba(59, 130, 246, 0.22);
